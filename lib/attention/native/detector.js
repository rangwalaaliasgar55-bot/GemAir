...
// The npm `electron` entry point may try to download its runtime when loaded by
// plain Node. Only resolve it when Electron has already booted this process.
if (process.versions && process.versions.electron) {
  try { ({ powerMonitor } = require('electron')); } catch { /* unavailable in this process */ }
}
