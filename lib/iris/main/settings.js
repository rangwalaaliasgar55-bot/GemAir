    ...
    constructor() {
        ...
        try {
            if (fs.existsSync(this.filePath)) {
                ...
                // Known keys only. Spreading `rawParsed` wholesale would carry a
                // pre-fork install's plaintext `anthropicApiKey` straight back out
                // to disk on the very save that is supposed to remove it, and
                // would keep a dead `aiProvider: "openai"` alive forever.
